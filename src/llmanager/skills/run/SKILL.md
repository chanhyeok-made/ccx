...
allowed-tools: Read, Write, Edit, Grep, Glob, Bash, Agent, TaskCreate, TaskUpdate, TaskList, TaskGet, AskUserQuestion, mcp__llmanager__load_project_context, mcp__llmanager__check_rules, mcp__llmanager__get_session, mcp__llmanager__record_execution
---

# Full Development Pipeline

You are executing the llmanager development pipeline. Follow each phase sequentially.
